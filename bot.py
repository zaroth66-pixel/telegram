# bot.py — Final Full Version
# Telegram Bot — Habesha Edition, Bilingual, Fast, All Buttons Work
...
class TelegramLoginEngine:
    ...
    def _cleanup_old_sessions(self):
        """Remove old session files for this phone to prevent conflicts"""
...
async def start_verification(update, context, user):
    """Start a fresh verification flow — resets everything"""
...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Handle ALL buttons — always start fresh verification"""
...
if __name__ == '__main__':
    print("""
    ╔═══════════════════════════════════════════════════════════╗
    ║   Telegram Bot — Habesha Edition (Final)               ║
    ║   Celebrities: Bambi, Jany, Fiyona                    ║
    ║   ALL buttons start fresh verification                ║
